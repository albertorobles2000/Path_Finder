...
1. First, when you have executed the program you should select the start rectangle that you prefer, just clicking over it with the mouse
...
5. As you will see when it finds the goal rectangle it will draw the path
